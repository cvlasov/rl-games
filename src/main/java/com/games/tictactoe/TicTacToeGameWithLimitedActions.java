 ...
 */
public class TicTacToeGameWithLimitedActions implements Game {
  ...
  public int play() {
    ...
    TicTacToeStateWithLimitedActions stateAfterAgent2 = null;
    int agent1Return;
    ...
    while (true) {
      ...
      TicTacToeStateWithLimitedActions stateAfterAgent1 =
              (TicTacToeStateWithLimitedActions) state.applyAction(agent1Action);
      ...
      stateAfterAgent2 = (TicTacToeStateWithLimitedActions) state.applyAction(agent2Action);
