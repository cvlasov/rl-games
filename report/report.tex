...
\begin{figure}[htbp]
    \centering
    \subfigure[Normal Tic-Tac-Toe]{\includegraphics[width=0.75\linewidth]{TicTacToeNormal_EpsilonResults_Wins_Comparison.png}}
    \subfigure[Chung Toi]{\includegraphics[width=0.75\linewidth]{ChungToi_EpsilonResults_Wins_Comparison.png}}
    \subfigure[Nim]{\includegraphics[width=0.75\linewidth]{Nim_EpsilonResults_Wins_Comparison.png}}
...
This suggests that the SE implementation makes the MC agent's policy converge much faster. To test this, we run convergence experiments on both implementations for several values of epsilon and compare the results in Figure \ref{fig:tictactoe-normal-vs-symmetric-equality-performance}.
